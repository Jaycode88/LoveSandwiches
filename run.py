...
"""
Update_surplus_worksheet and update_sales_worksheet functions no longer needed 
Due to update_worksheet now acts for all worksheets

def update_surplus_worksheet(surplus_data):
    ***
    Update surplus worksheet, add new row with the list data from calculation
    ***
...
def update_worksheet(data, worksheet):
    ...
    work_to_update = SHEET.worksheet(worksheet)
    work_to_update.append_row(data)
